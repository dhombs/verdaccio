...
Verdaccio is plugabble aplication. Currently there is only support for [Authentification](auth.md) but there are plans to [improve the plugin system](https://github.com/verdaccio/verdaccio/issues/169). If you are interested in developing your own plugin read the [development](development.md) section.
